            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select name="subcategory" class="form-control" id="subcategory">
                        ...
                        @if(old('category'))
                            @foreach(App\Models\Subcategory::whereCategoryId(old('category'))->orderBy('name')->get() as $key => $value)
                                <option value="{{ $value->id }}" @if($value->id==old('subcategory')) selected @endif>{{ $value->name }}</option>
                            @endforeach
                        @endif
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="3">{{ old('decription') }}</textarea>
                </div>
                <div class="form-group">
